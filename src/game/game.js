  ...
  Game.prototype = {
    ...
    _drawPauseScreen: function() {
      switch (this.state.currentStatus) {
        case Verdict.WIN:
          canvas.drawTextBox(this, 'Пресвятые хоббитсы, я попал! ПОПАЛ!! ПОПААААЛ!!');
          break;
        case Verdict.FAIL:
          canvas.drawTextBox(this, 'Ааа, как обычно...');
          break;
        case Verdict.PAUSE:
          canvas.drawTextBox(this, 'Пауза в игре! Передохну...');
          break;
        case Verdict.INTRO:
          canvas.drawTextBox(this, 'Тебя приветствует волшебник, Пендальф синий, повелитель драконов, низвергатель богов, в общем скромный парнишка! Хочешь поиграть со мной? Нажми пробел.');
          break;
      }
    },
